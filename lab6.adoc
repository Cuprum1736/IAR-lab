...
== ВЫВОД
Разобрались почему не работала кнопка, подключили TIM2. Описана система тактирования на внутреннем и внешнем источниках. Описаны порты ввода вывода общего назначения(GPIO).
