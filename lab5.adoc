...
Целью данной лабораторной работы является разработка архитектуры программной системы для управления группой светодиодов с использованием объектно-ориентированных принципов проектирования. В процессе выполнения работы необходимо:

* Определить ключевые абстракции системы

* Спроектировать интерфейсы для взаимодействия между компонентами

* Реализовать различные режимы работы светодиодов с использованием 
паттерна Стратегия

* Разделить существующий код на классы, используя .cpp и .h файлы. А так же с использованием интефейсов.
...
Сначала мы выполнили поставленную задачу. Научились моргать светодиодом. Но затем по ходу выполнения работы добавилась необходимость включать и выключать светодиоды отдельно. Для этого мы разбили код на классы. И стали обращаться к ним отдельно, в зависимости от выполняемой задачи функции.
...
Разработанная архитектура, показанная на рисунке 1 <<UML-diagram>> демонстрирует эффективное применение объектно-ориентированных принципов проектирования в области встраиваемых систем. Ключевыми достижениями являются:
